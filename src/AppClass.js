                    ...
                    {this.state.selectedEvent && (
                        ...
                        >
                            <div style={{ padding: "0", width: "120px", height: "140px", fontSize: "10px" }}>
                                ...
                                <p>{this.state.selectedEvent.title}<br></br>
                                    {this.state.selectedEvent.address.city}, {this.state.selectedEvent.address.street} {this.state.selectedEvent.address.houseNumber}<br></br>
                                    <b>{this.state.selectedEvent.date.day}.{this.state.selectedEvent.date.month}.{this.state.selectedEvent.date.year}</b></p>
                                <button style={{
                                    display: "block",
                                    marginLeft: "auto",
